<template>
  <div class="container">
    <global-heager :user="currrentUser"></global-heager>
...
import globalHeager, { UserProps } from "./components/global-header.vue";
import validateInput, { RulesProp } from "./components/validate-input.vue";

const currrentUser: UserProps = {
  isLogin: true,
  name: "hq"
};
